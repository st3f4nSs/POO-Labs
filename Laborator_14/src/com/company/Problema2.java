...
class ListUtil {
    ...
    public static <A, B> A foldr(Function<A, Function<B, A>> function, A acc, List<B> xs) { return null; }
    ...
    public static <A extends Number, Addition> A sum(List<A> xs, Addition operation) {
        return null;
    }
}